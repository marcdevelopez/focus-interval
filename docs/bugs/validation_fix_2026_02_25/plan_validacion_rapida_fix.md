...
9. Fix 9 (Scope 11): Done (2026-02-26, tests: `flutter analyze`, commit: pending) — unified Run Mode start pipeline with in-memory snapshot; prior attempt 16d2098 superseded.
